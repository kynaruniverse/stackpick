 ...
 * 6. Export assets/js/data/*.js (products, collections, search-index)
 * 7. Stamp sw.js with build-time version
 */
...
const filesToClean = [
  ...
  path.join(ROOT, 'assets/js/data/search-index.js'),   // generated by export-js-data.js
];
...
// ---------------------------------------------------------------------------
// Step 6: Export JS data files (products, collections, search-index)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Step 7: Stamp sw.js with build-time version
// ---------------------------------------------------------------------------
console.log('\nStep 7 — Stamping sw.js with build version...');
try {
  const swPath    = path.join(ROOT, 'sw.js');
  const timestamp = new Date().toISOString().replace(/[-:T]/g, '').slice(0, 14);
  const version   = `sp-${timestamp}`;
  const swContent = fs.readFileSync(swPath, 'utf8');
  fs.writeFileSync(swPath, swContent.replace(/"sp-\d{14}"|__SP_VERSION__/, JSON.stringify(version)));
